...
namespace PaymentNetwork\PaymentGateway\Model\Method;
...
use PaymentNetwork\SDK\AmountHelper;
use PaymentNetwork\SDK\Gateway;
...
class PaymentNetworkMethod extends AbstractMethod {
    ...
    protected $_code                   = 'PaymentNetwork_PaymentGateway';
